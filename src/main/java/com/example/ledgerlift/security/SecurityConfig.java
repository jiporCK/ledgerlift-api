        ...
        http
                .authorizeHttpRequests(request -> {
                    request
                            ...
                            .requestMatchers("api/v1/organizations/**").hasAnyAuthority("SCOPE_organizer:read", "SCOPE_organizer:write")
                            .requestMatchers(HttpMethod.GET, "api/v1/events/urgent-events").hasAuthority("SCOPE_admin:read")
                            ...
                            .requestMatchers(HttpMethod.GET, "api/v1/media/**").hasAnyAuthority("SCOPE_donor:read", "SCOPE_donor:write","SCOPE_organizer:read", "SCOPE_organizer:write", "SCOPE_admin:read", "SCOPE_admin:write")

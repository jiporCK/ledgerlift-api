...
public class FabricUtils {
    ...
    public static void setTlsProps(Properties props, String org1CertificatePath, Boolean tlsEnabled) throws Exception {
        ...
        if (tlsEnabled) {
            ...
            if (!pemFile.exists()) {
                throw new Exception("Certificate file " + org1CertificatePath + " does not exist");
            }
